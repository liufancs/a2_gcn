...
import argparse
def parse_args():
    parser = argparse.ArgumentParser(description="Run a2-gcn.")
    ...
    parser.add_argument('--dataset', nargs='?', default='Off',
                        help='Choose a dataset from {Toys_and_Games, Cloth, Kin}')
    ...
    parser.add_argument('--n_relations', type=int, default=4,
                        help='number of relations between nodes.')
    ...
    parser.add_argument('--Ks', nargs='?', default='[20, 10]',
                        help='Output sizes of every layer')
